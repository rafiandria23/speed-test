...
console.log("\n", infoAgustus("Rabu", 4)); // Hari Rabu, 21 Agustus 2019 bukan hari libur
console.log("\n", infoAgustus("Sunday", 3)); // Hari Minggu, 11 Agustus 2019 adalah hari libur weekend dan juga tanggal merah
console.log("\n", infoAgustus("Sabtu", 3)); // Hari Sabtu, 17 Agustus 2019 adalah hari libur weekend dan juga tanggal merah
console.log("\n", infoAgustus("Minggu", 5)); // Hari Minggu, 25 Agustus 2019 adalah hari libur weekend
console.log("\n", infoAgustus("Thursday", 3)); // Hari Kamis, 15 Agustus 2019 bukan hari libur
console.log("\n", infoAgustus("Minggu", 0)); // Input minggu harus dalam range 1 - 5
console.log("\n", infoAgustus("Senin", 6)); // Input minggu harus dalam range 1 - 5
console.log("\n", infoAgustus("Kliwon", 1)); // Input hari harus dalam bahasa Indonesia atau Inggris yang benar
